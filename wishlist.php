...
<head>
    ...
    <title>Booksmart Bazaar - my wishlist page</title>
                            ...
                            <div class="content">
                                ...
                                <div class="button">
                                    ...
                                    <div>
                                        ...
                                        <button type="submit" name="delete_item" onclick="return confirm('remove from wishlist'); "><i class="fa-solid fa-xmark"></i></button>
                                    </div>
                                </div>
