...
if(isset($_POST['draft'])){
    ...
    if($select_image->rowCount() > 0 AND $image != ''){
        ...
        $success_msg[] = 'product save a draft successfully';
    }
}
...
<head>
    ...
    <title>Booksmart Bazaar - seller addproduct</title>
        ...
        <section class="post-editor">
            ...
            <form action="" method="post" enctype="multipart/form-data" class="register">
                ...
                <div class="input-field">
                    ...
                    <textarea name="description" maxlength="1000" placeholder="add product detail" class="box" required></textarea>
                </div>

                <div class="input-field">
                    <p>product stock <span>*</span></p>
                    <input type="text" name="stock" maxlength="10" min="0" max="99999999" placeholder="add product stock" required class="box">
                </div>
